...
while True:
  ...
  # results of choices
    ...
    if choice == "1":
      ...
      print("\nYou miss out on practice to go party, and you end up playing losing valuable practice time. You keep on partying under the influence of your friends, and you are unable to improve your skills at basketball")
